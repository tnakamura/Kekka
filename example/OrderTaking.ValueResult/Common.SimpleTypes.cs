...
internal static class ConstrainedType
{
    ...
    /// </summary>
    public static ValueResult<T, string> CreateString<T>(
        string fieldName,
        Func<string, T> ctor,
        int maxLen,
        string str)
    {
        if (string.IsNullOrEmpty(str))
        {
            ...
            return ValueResult.Error<T, string>(msg);
        }
        ...
        {
            return ValueResult.Ok<T, string>(ctor(str));
        }
    }
    ...
    /// </summary>
    public static ValueResult<T?, string> CreateStringOption<T>(
        string fieldName,
        Func<string, T?> ctor,
        int maxLen,
        string? str)
    {
        if (string.IsNullOrEmpty(str))
        {
            return ValueResult.Ok<T?, string>(default);
        }
        else if (str.Length > maxLen)
        {
            var msg = $"{fieldName} must not be more than {maxLen} chars";
    ...
    /// </summary>
    public static ValueResult<T, string> CreateInt<T>(
        string fieldName,
        Func<int, T> ctor,
        int minVal,
        int maxVal,
        int i)
    {
        ...
        {
            return ValueResult.Ok<T, string>(ctor(i));
        }
    }
    ...
    /// Return Error if input is less than minVal or more than maxVal
    /// </summary>
    public static ValueResult<T, string> CreateDecimal<T>(
        string fieldName,
        Func<decimal, T> ctor,
        decimal minVal,
        decimal maxVal,
    ...
    /// </summary>
    public static ValueResult<T, string> CreateLike<T>(
        string fieldName,
        Func<string, T> ctor,
        string pattern,
        string str)
...
partial class String50
{
    ...
    /// </summary>
    public static ValueResult<String50, string> Create(string fieldName, string str) =>
    ...
    /// Return Some if the input is valid
    /// </summary>
    public static ValueResult<String50?, string> CreateOption(string fieldName, string? str) =>
...
partial class EmailAddress
{
    ...
    /// </summary>
    public static ValueResult<EmailAddress, string> Create(string fieldName, string str)
    {
...
partial class ZipCode
{
    ...
    /// </summary>
    public static ValueResult<ZipCode, string> Create(string fieldName, string str)
    {
        var pattern = "\\d{5}";
...
partial class OrderId
{
    ...
    /// Return Error if input is null, empty, or length > 50
    /// </summary>
    public static ValueResult<OrderId, string> Create(string fieldName, string str) =>
...
partial class OrderLineId
{
    ...
    /// Return Error if input is null, empty, or length > 50
    /// </summary>
    public static ValueResult<OrderLineId, string> Create(string fieldName, string str) =>
...
partial class ProductCode
{
    partial class WidgetCode
    {
        ...
        /// </summary>
        public static ValueResult<WidgetCode, string> CreateWidgetCode(string fieldName, string code)
        {
            // The codes for Widgets start with a "W" and then four digits
            var pattern = "W\\d{4}";
...
partial class ProductCode
{
    partial class GizmoCode
    {
        ...
        /// Return Error if input is null, empty, or not matching pattern
        /// </summary>
        public static ValueResult<GizmoCode, string> CreateGizmoCode(string fieldName, string code)
        {
            // The codes for Gizmos start with a "G" and then three digits.
            var pattern = "G\\d{3}";
...
partial class ProductCode
{
    ...
    /// Return Error if input is null, empty, or not matching pattern
    /// </summary>
    public static ValueResult<ProductCode, string> Create(string fieldName, string code)
    {
        if (string.IsNullOrEmpty(code))
        {
            var msg = $"{fieldName}: Must not be null or empty";
            return ValueResult.Error<ProductCode, string>(msg);
        }
        else if (code.StartsWith("W"))
        {
            var ValueResult = WidgetCode.CreateWidgetCode(fieldName, code);
            return ValueResult.Select<WidgetCode, ProductCode, string>(x => x);
        }
        else if (code.StartsWith("G"))
        {
            var ValueResult = GizmoCode.CreateGizmoCode(fieldName, code);
            return ValueResult.Select<GizmoCode, ProductCode, string>(x => x);
        }
        else
        {
...
partial class OrderQuantity
{
    partial class UnitQuantity
    {
        ...
        /// </summary>
        public static ValueResult<UnitQuantity, string> CreateUnitQuantity(string fieldName, int v) =>
...
partial class OrderQuantity
{
    partial class KilogramQuantity
    {
        ...
        /// </summary>
        public static ValueResult<KilogramQuantity, string> CreateKilogramQuantity(string fieldName, decimal v) =>
...
partial class OrderQuantity
{
    ...
    /// </summary>
    public static ValueResult<OrderQuantity, string> Create(string fieldName, ProductCode productCode, decimal quantity)
    {
        if (productCode is ProductCode.WidgetCode)
        {
            var ValueResult = UnitQuantity.CreateUnitQuantity(fieldName, (int)quantity);
            return ValueResult.Select<UnitQuantity, OrderQuantity, string>(x => x);
        }
        else
        {
            var ValueResult = KilogramQuantity.CreateKilogramQuantity(fieldName, quantity);
            return ValueResult.Select<KilogramQuantity, OrderQuantity, string>(x => x);
        }
    }
}
...
partial class Price
{
    ...
    /// </summary>
    public static ValueResult<Price, string> Create(decimal v) =>
    ...
    /// </summary>
    public static ValueResult<Price, string> operator *(Price qty, Price p) =>
...
partial class BillingAmount
{
    ...
    /// </summary>
    public static ValueResult<BillingAmount, string> Create(decimal v) =>
    ...
    /// </summary>
    public static ValueResult<BillingAmount, string> SumPrices(IEnumerable<Price> prices)
    {
