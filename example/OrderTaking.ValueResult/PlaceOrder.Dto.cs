...
internal static class CustomerInfoDtoExtensions
{
    ...
    /// </summary>
    public static ValueResult<CustomerInfo, string> ToCustomerInfo(this CustomerInfoDto dto)
    {
...
internal static class AddressDtoExtensions
{
    ...
    /// Used when importing from the outside world into the domain, eg loading from a database.
    /// </summary>
    public static ValueResult<Common.Address, string> ToAddress(this AddressDto dto)
    {
        var result =
